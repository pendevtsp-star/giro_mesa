...
export const appNavigationItems = [
  ...
  },
  {
    group: "management",
    icon: ClipboardList,
    labelKey: "nav.staffFinance",
    href: "/app/team/settlements",
    permissions: ["staff_finance:manage"],
  },
  {
    group: "operation",
    icon: ClipboardList,
    labelKey: "nav.staffFinanceSelf",
    href: "/app/waiter/settlement",
    permissions: ["staff_finance:read_self"],
  },
  {
    group: "settings",
    icon: FileCheck2,
  ...
  },
  {
    group: "management",
    icon: CreditCard,
    labelKey: "nav.paymentReconciliation",
    href: "/app/finance/payment-reconciliation",
    permissions: ["staff_finance:manage"],
  },
  {
    group: "settings",
