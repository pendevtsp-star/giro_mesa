...
const env: AppEnv = {
  ...
  API_INSTANCE_ID: "worker-test",
  REALTIME_POLL_INTERVAL_MS: 1_000,
  REALTIME_BATCH_LIMIT: 200,
  REDIS_URL: "redis://localhost:6380",
  SESSION_SECRET: "local-development-session-secret",
  FEDERATION_ISSUER_URL: "https://accounts.giromesa.test",
  FEDERATION_HANDOFF_SECRET: "local-development-federation-handoff-secret",
  DOSECLUB_PUBLIC_URL: "https://doseclube.giromesa.test",
  DOSECLUB_SSO_EXCHANGE_KEY: "local-development-doseclub-sso-exchange-key",
  QR_SIGNING_SECRET: "local-development-qr-signing-secret",
